  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authData.user) {
        ...
        // Usamos 'as any' temporalmente para evitar errores de tipos
        ...
        {isSuccess ? (
          <div className="py-10 flex flex-col items-center justify-center text-center animate-in fade-in zoom-in duration-500">
            ...
            <div className="mt-8 w-full bg-gray-100 h-1.5 rounded-full overflow-hidden">
              <div
                className="h-full bg-green-500 animate-[loading_1.5s_ease-in-out_forwards]"
                style={{ width: "0%" }}
              ></div>
            </div>
            <style jsx>{`
          ...
          <div className="animate-in fade-in duration-500">
            ...
            >
              ...
              {/* --- AQUÍ ESTÁ EL CAMBIO: LINK RECUPERAR CONTRASEÑA --- */}
